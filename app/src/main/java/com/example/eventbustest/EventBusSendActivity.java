...
import com.example.eventbustest.event.MessageEvent;
import com.example.eventbustest.event.StickyEvent;
...
public class EventBusSendActivity extends Activity {
    private static final String TAG = "EventBusSendActivity";
    ...
    public void StickyEventBus(StickyEvent event){
        ...
        Log.d(TAG, "StickyEventBus: "+event.msg);
    }

    private void initData() {
        tv_title.setText("B-EventBus发送数据页面");
    }
